...
export function getTodayCheckInStatusForTask(taskDetail: any): { canCheckIn: boolean; todayCount: number; todayValue: number; isCompleted: boolean; dailyTarget?: number } {
    ...
    const todayCheckIns = (targetGoalDetail.checkIns || []).filter(c => c.date === effectiveToday);
